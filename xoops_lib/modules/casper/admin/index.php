...
$menu = new casperMenu();
$menu->addItem("example",  _AM_CASPER_MANAGER_EXAMPLE,  "example.php" );
$menu->addItem("about",       _AM_CASPER_MANAGER_ABOUT,       "about.php");
$menu->addItem("help",       _AM_CASPER_MANAGER_HELP,       "help.php");
$xoopsTpl->assign("casper_menu", $menu->_items );

$admin = new casperMenu();
$admin->addItem("update",      _AM_CASPER_MANAGER_UPDATE,      "../../system/admin.php?fct=modulesadmin&op=update&module=casper" );
