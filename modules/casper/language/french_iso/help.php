...
define("_AM_CASPER_HELP1" , "<p><strong>Note:</strong> Cette section d'aide à la création d'un module sera actualisée au fur et à mesure des évolutions futures de <span class='bold italic'>\"Casper\"</span>.</p>");
...
");
define("_AM_CASPER_HELP4" , "<h4>Autres documentations</h4>");
